...
$(document).ready(function () {
    ...
    $("#selectPermarentCountry").change(function () {
        ...
        // Make AJAX request to get states based on the selected country
        $.ajax({
            type: "POST",
            ...
            success: function (data) {
                // Populate PermarentStateField dropdown with retrieved states
                var statesDropdown = $("#selectPermanentState");
    ...
    $("#selectCurrentCountry").change(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                // Populate PermarentStateField dropdown with retrieved states
                var statesDropdown = $("#selectCurrentState");
                statesDropdown.empty();
                $.each(data, function (index, item) {
                    statesDropdown.append($('<option>', {
                        value: item.StateId,
...
function updateCountry() {
    ...
    $.ajax({
        type: 'POST',
        url: '/UserRegistration/GetAllCountries', // Adjust the URL path
        dataType: 'json',
        success: function (data) {
            // Handle the returned data (list of countries) here
            console.log(data);
        },
...
function validateForm() {
    ...
    //    type: "POST",
    //    contentType: "application/json; charset=utf-8",
    //    url: "UserRegistration2/UserSave", 
    //    data: jsonData,
    //    dataType: "json",
    //    success: function (data) {
    //        alert("Success");
